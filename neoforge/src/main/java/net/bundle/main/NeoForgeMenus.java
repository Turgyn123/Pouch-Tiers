...
public class NeoForgeMenus {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<BundleMenu>> BUNDLE_MENU =
            MENUS.register("bundle_menu", () -> new MenuType<>(BundleMenu::new, FeatureFlagSet.of()));
    ...
    public static void register(IEventBus bus) {
        ...
        bus.addListener((RegisterEvent event) -> {
            if (event.getRegistryKey() == Registries.MENU) {
                ...
                ModMenuTypes.setBundleMenu(BUNDLE_MENU.get());
                ModMenuTypes.BUNDLE_MENU = BUNDLE_MENU.get(); // For backward compatibility
            }
        });
    }
}
