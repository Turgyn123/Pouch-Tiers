 ...
 * to an RGB value used for the pouch GUI background tinting.
 */
public enum PouchColor {
    DEFAULT(0x835432),
    WHITE(0xF9FFFE),
    LIGHT_GRAY(0x9D9D97),
    GRAY(0x474F52),
    ...
    /**
     * Derives the pouch GUI color from the item's registry path.
     * e.g. "red_pouch" → RED, "red_copper_pouch" → RED, "pouch" → DEFAULT.
     */
    public static PouchColor fromItemPath(String path) {
